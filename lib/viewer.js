...
exports.setup = function(element) {
  ...
  this.update = function(layout, element) {
    exports.insert(nodeCache, linkCache, layout, element);
  };
...
exports.getNodes = function(data) {
  if (data.hasOwnProperty('stream')) {
    return _.filter(data.stream, function(datum) { return datum.type === "node"; });
  } else {
...
exports.getLinks = function(data) {
  if (data.hasOwnProperty('stream')) {
    return _.filter(data.stream, function(datum) { return datum.type === "link"; });    
  } else {
